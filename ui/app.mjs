import {PROVIDERS,percent,resetText,statusText,ageText,visibleWindows,innerWindow,enabledProviders,POPUP_WIDTH,accountText,RING_COLORS,ringHex,providerSwatch} from './model.mjs';
